...
const audioSources: Record<AudioId, string | null> = {
    ...
    [AudioId.TimerUp]: null,
    [AudioId.TimeToDay]: '/audio/time-to-day.mp3',
    [AudioId.TimeToEvening]: null,
    [AudioId.TimeToNight]: null,
    [AudioId.RoleAssigned]: null,
    [AudioId.Nomination]: null,
    [AudioId.PlayerDead]: null,
    [AudioId.PlayerRevive]: null,
    [AudioId.HandPassUp]: null,
    [AudioId.HandPassDown]: null,
    [AudioId.TalkRequest]: null
};
