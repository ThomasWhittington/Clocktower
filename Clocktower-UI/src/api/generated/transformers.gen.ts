...
import type {CancelTimerApiResponse, CheckGuildApiResponse, GetAuthDataApiResponse, GetAvailableGameUsersApiResponse, GetDiscordTownApiResponse, GetGamePerspectivesApiResponse, GetGamesApiResponse, GetGuildsWithUserApiResponse, GetJoinDataApiResponse, GetPlayerGamesApiResponse, GetRolesApiResponse, GetTimerApiResponse, GetTownStatusApiResponse, HealthApiResponse, SetScriptApiResponse, StartGameApiResponse, StartOrEditTimerApiResponse} from './types.gen';
...
export const getAvailableGameUsersApiResponseTransformer = async (data: any): Promise<GetAvailableGameUsersApiResponse> => {
...
const clocktowerServerDataGamePerspectiveSchemaResponseTransformer = (data: any) => {
    if (data.createdBy) {
...
const clocktowerServerDataScriptSchemaResponseTransformer = (data: any) => {
    if (data.roles) {
...
export const getGamePerspectivesApiResponseTransformer = async (data: any): Promise<GetGamePerspectivesApiResponse> => {
    data = data.map((item: any) => {
        return clocktowerServerDataGamePerspectiveSchemaResponseTransformer(item);
    });
    return data;
};
...
const clocktowerServerDataMiniGamePerspectiveSchemaResponseTransformer = (data: any) => {
    if (data.createdBy) {
        data.createdBy = clocktowerServerDataGameUserSchemaResponseTransformer(data.createdBy);
    }
    if (data.createdDate) {
...
export const getPlayerGamesApiResponseTransformer = async (data: any): Promise<GetPlayerGamesApiResponse> => {
    data = data.map((item: any) => {
        return clocktowerServerDataMiniGamePerspectiveSchemaResponseTransformer(item);
    });
    return data;
};

export const setScriptApiResponseTransformer = async (data: any): Promise<SetScriptApiResponse> => {
    data = clocktowerServerDataScriptSchemaResponseTransformer(data);
    return data;
};

export const startGameApiResponseTransformer = async (data: any): Promise<StartGameApiResponse> => {
    data = clocktowerServerDataGamePerspectiveSchemaResponseTransformer(data);
    return data;
};
