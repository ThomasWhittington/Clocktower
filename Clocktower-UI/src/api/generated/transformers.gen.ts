...
import type {CancelTimerApiResponse, CheckGuildApiResponse, GetAuthDataApiResponse, GetDiscordTownApiResponse, GetGameApiResponse, GetGamesApiResponse, GetGuildsWithUserApiResponse, GetJoinDataApiResponse, GetPlayerGamesApiResponse, GetPlayerGameStateApiResponse, GetRolesApiResponse, GetTimerApiResponse, GetTownStatusApiResponse, HealthApiResponse, StartGameApiResponse, StartOrEditTimerApiResponse} from './types.gen';
...
export const getPlayerGameStateApiResponseTransformer = async (data: any): Promise<GetPlayerGameStateApiResponse> => {
    data = clocktowerServerDataGameStateDtoSchemaResponseTransformer(data);
    return data;
};
