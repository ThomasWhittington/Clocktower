...
[TestClass]
public class SetReminderRequestValidatorTests
{
    private SetReminder.RequestValidator _validator = null!;
    private const string ValidSnowflake = "123456789012345678";

    [TestInitialize]
    public void Setup()
    {
        _validator = new SetReminder.RequestValidator();
    }

    [TestMethod]
    public void Validate_ShouldNotHaveErrors_WhenRequestIsValid()
    {
        var request = new SetReminder.Request("gameId", ValidSnowflake, "role-reminder");
    ...
    {
        var request = new SetReminder.Request(invalidGameId, ValidSnowflake, "role-reminder");
    ...
    {
        var request = new SetReminder.Request("valid-game", "", "role-reminder");
    ...
    {
        var request = new SetReminder.Request("valid-game", "invalid-user", "role-reminder");
    ...
    {
        var request = new SetReminder.Request("valid-game", ValidSnowflake, "");
