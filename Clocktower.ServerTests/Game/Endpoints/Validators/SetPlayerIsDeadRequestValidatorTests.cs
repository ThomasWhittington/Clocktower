...
[TestClass]
public class SetPlayerIsDeadRequestValidatorTests
{
    ...
    public void Setup()
    {
        _validator = new SetPlayerIsDead.RequestValidator();
    }

    [TestMethod]
    public void Validate_ShouldNotHaveErrors_WhenRequestIsValid()
    {
        var request = new SetPlayerIsDead.Request("valid-game", CommonMethods.GetRandomSnowflakeStringId(), RandomBool);
    ...
    {
        var request = new SetPlayerIsDead.Request(invalidGameId, ValidSnowflake, RandomBool);
    ...
    public void Validate_ShouldHaveError_WhenGameIdIsTooLong()
    {
        ...
        var request = new SetPlayerIsDead.Request(longGameId, ValidSnowflake, RandomBool);
    ...
    {
        var request = new SetPlayerIsDead.Request("  abc  ", ValidSnowflake, RandomBool);
