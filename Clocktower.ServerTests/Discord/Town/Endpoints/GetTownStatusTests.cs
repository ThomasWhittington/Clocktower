...
public class GetTownStatusTests
{
    ...
    public void Handle_ReturnsBadRequest_WhenServiceReturnsFalse()
    {
        ...
        _mockDiscordTownService.Setup(o => o.GetTownStatus(request.GuildId)).Returns((false, false, responseMessage));

        var result = GetTownStatus.Handle(request, _mockDiscordTownService.Object);

        _mockDiscordTownService.Verify(o => o.GetTownStatus(request.GuildId), Times.Once);
    ...
    public void Handle_ReturnsOk_WhenServiceReturnsTrue()
    {
        ...
        _mockDiscordTownService.Setup(o => o.GetTownStatus(request.GuildId)).Returns((true, true, responseMessage));
